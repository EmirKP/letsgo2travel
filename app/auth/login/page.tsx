...
import { Lock, Mail, ArrowRight, Plane, AlertCircle } from "lucide-react";
      ...
      <div style={{
        ...
        <div style={{ textAlign: "center", marginBottom: "40px" }}>
          ...
          <p style={{ color: "#94a3b8", fontSize: "0.9rem", margin: 0 }}>
            Favori rotalarına ve fiyat alarmlarına ulaşmak için giriş yap.
          </p>
        </div>
        ...
        <form onSubmit={handleLogin} style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          ...
          <div style={{ display: "flex", justifyContent: "flex-end" }}>
            <Link href="/sifremi-unuttum" style={{ color: "#1476F2", fontSize: "0.85rem", fontWeight: "600", textDecoration: "none" }}>
              Şifremi Unuttum
            </Link>
          </div>
        ...
        <div style={{ textAlign: "center", marginTop: "32px", fontSize: "0.9rem", color: "#94a3b8" }}>
          ...
          <Link href="/auth/register" style={{ color: "#1476F2", fontWeight: "700", textDecoration: "none" }}>
            Hemen Kayıt Ol
          </Link>
        </div>
      </div>
