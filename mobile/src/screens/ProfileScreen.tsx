  ...
  return <div className="screen profile-screen">
    ...
    <section className="profile-section">
      ...
      <div className="profile-action-list">
        ...
        <button onClick={() => onNavigate("trips")}><span><Icon name="heart" size={21} /></span><div><strong>{copy("Kaydedilenler", "Saved")}</strong><small>{copy("Konser, festival ve etkinlik planların", "Concerts, festivals and event plans")}</small></div><Icon name="chevron" size={17} /></button>
