  ...
  return <div className="screen alerts-screen">
    ...
    {formOpen && <form className="form-card alert-form" onSubmit={submitAlert}>
      ...
      <div className="form-grid two stack-narrow">
        <DateTimeField type="date" required label={copy("Gidiş tarihi", "Departure date")} min={localIsoDate(0)} max={localIsoDate(730)} value={form.departureDate} onChange={(requested) => {
