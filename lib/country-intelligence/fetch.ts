...
const ALLOWED_HOSTS = new Set(["api.frankfurter.dev", "ec.europa.eu", "api.worldbank.org", "www.gov.uk", "api.gdeltproject.org", "date.nager.at", "www.aa.com.tr", "feeds.bbci.co.uk", "www.val.se", "elections.nz"]);
